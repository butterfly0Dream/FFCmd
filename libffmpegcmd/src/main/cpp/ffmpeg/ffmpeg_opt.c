...
{
    av_log(NULL, AV_LOG_FATAL,"Quit at %s","open_input_file start");
    InputFile *f;
    AVFormatContext *ic;
    ...
    av_log(NULL, AV_LOG_FATAL,"Quit at %s","open_input_file half start");
    err = avformat_open_input(&ic, filename, file_iformat, &o->g->format_opts);
    av_log(NULL, AV_LOG_FATAL,"Quit at %s","open_input_file half end");
    ...
    av_log(NULL, AV_LOG_FATAL,"Quit at %s","open_input_file end");
    return 0;
}
...
{
    av_log(NULL, AV_LOG_FATAL, "open_files start");
    int i, ret;
    ...
    for (i = 0; i < l->nb_groups; i++) {
        ...
        av_log(NULL, AV_LOG_FATAL, "open_files parse_optgroup start");

        ret = parse_optgroup(&o, g);

        av_log(NULL, AV_LOG_FATAL, "open_files parse_optgroup end");
        ...
        av_log(NULL, AV_LOG_FATAL, "open_files open_file start");

        ret = open_file(&o, g->arg);//应该是这里出问题了

        av_log(NULL, AV_LOG_FATAL, "open_files open_file end");
    ...
    //没走到这儿
    av_log(NULL, AV_LOG_FATAL, "open_files end");
...
{
    av_log(NULL, AV_LOG_FATAL, "Error Log ffmpeg_parse_options");
